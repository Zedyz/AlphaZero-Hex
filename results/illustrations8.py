...
file_names = [
    '1_vs_1_mod_6_vs_4.txt',
    '2_vs_2_mod_6_vs_4.txt',
    '3_vs_3_mod_6_vs_4.txt',
    '4_vs_4_mod_6_vs_4.txt',
    '5_vs_5_mod_6_vs_4.txt',
    '6_vs_6_mod_6_vs_4.txt',
    '7_vs_7_mod_6_vs_4.txt'
]
...
results_summary['Test Cases'] = ['Test 34', 'Test 35', 'Test 36', 'Test 37', 'Test 38', 'Test 39', 'Test 40']

# Plotting the distribution of wins as mirrored horizontal bars
fig, ax1 = plt.subplots(figsize=(6, 5))  # Increased height for better label display
...
plt.grid(True)
plt.tight_layout()  # Automatically adjust subplot parameters to fit the layout
plt.show()
